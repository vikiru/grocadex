...
ActiveItemRouter.post(
    baseUrl,
    ensureAuthenticated,
    ActiveItemController.createActiveItems,
);
ActiveItemRouter.get(
    baseUrl,
    ensureAuthenticated,
    ActiveItemController.getActiveItems,
);
ActiveItemRouter.delete(
    `${baseUrl}`,
    ensureAuthenticated,
    ActiveItemController.deleteActiveItems,
);
